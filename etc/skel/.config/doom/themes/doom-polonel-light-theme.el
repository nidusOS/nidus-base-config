;;; doom-polonel-light-theme.el --- inspired by Atom One Light -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-polonel-light-theme nil
  "Options for the `doom-polonel-light' theme."
  :group 'doom-themes)

(defcustom doom-polonel-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-polonel-light-theme
  :type 'boolean)

(defcustom doom-polonel-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-polonel-light-theme
  :type 'boolean)

(defcustom doom-polonel-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-polonel-light
  ...
  ((bg         '("#fafafa" "white"   "white"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-polonel-light-brighter-comments cyan base4))
   ...
   (modeline-fg-alt          (doom-blend
                              violet base4
                              (if doom-polonel-light-brighter-modeline 0.5 0.2)))
   (modeline-bg              (if doom-polonel-light-brighter-modeline
                                 (doom-darken base2 0.05)
                               base1))
   (modeline-bg-alt          (if doom-polonel-light-brighter-modeline
   ...
   (-modeline-pad
    (when doom-polonel-light-padded-modeline
      (if (integerp doom-polonel-light-padded-modeline) doom-polonel-light-padded-modeline 4))))

  ;;;; Base theme face overrides
  (((font-lock-comment-face &override)
    :background (if doom-polonel-light-brighter-comments base0))
   ...
   (mode-line-emphasis
    :foreground (if doom-polonel-light-brighter-modeline base8 highlight))
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-polonel-light-brighter-modeline modeline-bg highlight))
   ;;;; ediff <built-in>
...
;;; doom-polonel-light-theme.el ends here
