...
myTerminal :: String
myTerminal = "LIBGL_ALWAYS_SOFTWARE=1 alacritty"    -- Sets default terminal
...
myStartupHook = do
    ...
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x2f2f2f  --height 22 &"
    spawnOnce "/usr/bin/emacs --daemon &" -- emacs daemon for the emacsclient
    spawnOnce "xargs xwallpaper --stretch < ~/.wall"
  ...
  where
    ...
    manageTerm = customFloating $ W.RationalRect l t w h
               where
                 ...
                 t = 0.95 -h
                 l = 0.95 -w
    spawnNcspot  = myTerminal ++ " -t Ncspot -e ncspot"
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-S-<Return>", spawn "dmenu_run -nb \"#222222\" -sb \"#eeeeee\" -sf \"#2f2f2f\" -i -p \"Run: \"") -- Dmenu
    ...
    -- KB_GROUP Kill windows
        , ("M1-w", kill1)     -- Kill the currently focused client
        , ("M1-q", killAll)   -- Kill all windows on current workspace
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        ...
        , ("M-s m", namedScratchpadAction myScratchPads "ncspot")
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppCurrent = xmobarColor "#ffffff" "" . wrap "<box type=Bottom width=2 mb=2 color=#009EFF>" "</box>"                                        -- Current workspace
              , ppVisible = xmobarColor "#999999" "" . clickable              -- Visible but not current workspace
              , ppHidden = xmobarColor "#cccccc" "" . wrap "<box type=Top width=2 mt=2 color=#009EFF>" "</box>" . clickable -- Hidden workspaces
              , ppHiddenNoWindows = xmobarColor "#999999" ""  . clickable     -- Hidden workspaces (no windows)
              , ppTitle = xmobarColor "#eeeeee" "" . shorten 60               -- Title of active window
